#!/usr/bin/env node
/**
 * 自ガル14 update-materials 実行
 * /api/google/update-materials を叩いて動画管理シートK/M/N列をローカルMDで上書き
 */
import { readFile, writeFile } from 'fs/promises';

const descMdPath = 'C:/Users/meiek/Dropbox/アプリ/remotely-save/obsidian/02_youtube/ガルちゃんねる/自分動画/自社台本/【自ガル14】概要欄.md';
const pinMdPath = 'C:/Users/meiek/Dropbox/アプリ/remotely-save/obsidian/02_youtube/ガルちゃんねる/自分動画/自社台本/【自ガル14】固定コメント.md';
const workerMdPath = 'C:/Users/meiek/Dropbox/アプリ/remotely-save/obsidian/02_youtube/ガルちゃんねる/自分動画/自社台本/【自ガル14】ワーカーメッセージ.md';
...
console.log('\n🟢 update-materials完了');
await writeFile('C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/update_materials_gal14_result.json', JSON.stringify(json, null, 2));
