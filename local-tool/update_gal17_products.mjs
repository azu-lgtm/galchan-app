...
const items = [
  ...
  neg('ステルス値上げ食品（きのこの山74→66g/焼きのり10→8枚/ベーコン値上げ/カントリーマアム28→18枚/パイの実/明治おいしい牛乳1000→900ml/板チョコ100→208円/マヨ559円/赤いきつね248円/サラダ油）', '※値上げ・内容量減の実例（紹介のみ）'),
  ...
  posAmz('昔ながらの固形石けん'),
  posAmz('セザンヌ 口紅・アイシャドウ（プチプラ代案）'),
  posAmz('無印良品 基礎化粧品（デパコス代案）'),
  posAmz('米油（こめ油・オリーブオイル代案）'),
  posShop('格安SIM（mineo/楽天モバイル等・大手キャリア代案）', '※各社公式で契約・月千円前後'),
