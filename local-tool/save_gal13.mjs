...
/**
 * 自ガル13保存スクリプト
 * 事前に build_payload_gal13.mjs + pre_save_gate.mjs 通過必須
 * /api/google/save 経由で新規スプシ作成+動画管理シート追記
 */
import { readFile, writeFile } from 'fs/promises';
import { spawn } from 'child_process';

const payloadPath = 'C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/save_payload_gal13.json';
...
await writeFile(
  'C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/save_result_gal13.json',
