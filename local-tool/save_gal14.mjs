...
/**
 * 自ガル14保存スクリプト
 * 事前に build_payload_gal14.mjs + pre_save_gate.mjs 通過必須
 * /api/google/save 経由で新規スプシ作成+動画管理シート追記
 */
import { readFile, writeFile } from 'fs/promises';
import { spawn } from 'child_process';

const payloadPath = 'C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/save_payload_gal14.json';

const payload = JSON.parse(await readFile(payloadPath, 'utf8'));

console.log('🔒 Running pre_save_gate.mjs...');
// 🆕 2026-05-09: 100均テーマ・アフィ運用なし動画用に --skip-affiliate-check を付与
//   ユーザー明示指示「100均はアフィ運用しない」に対応・自ガル11事故対策の他項目は維持
await new Promise((resolve, reject) => {
  const p = spawn('node', [
    'C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/pre_save_gate.mjs',
    payloadPath,
    '--channel=galchan',
    '--skip-affiliate-check',
  ], { stdio: 'inherit' });
...
await writeFile(
  'C:/Users/meiek/Desktop/ClaudeCode-projects/galchan-app/local-tool/save_result_gal14.json',
